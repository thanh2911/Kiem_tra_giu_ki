...
from BusinessObject import Customer as CustomerEntity         #BANG 1
from BusinessObject import Categories as CategoriesEntity     #BANG 2
from BusinessObject import Employees as EmployeesEntity       #BANG 3
from BusinessObject import OrderDetails as OrderDetailsEntity #BANG 4
from BusinessObject import Orders as OrdersEntity             #BANG 5
from BusinessObject import Products as ProductsEntity         #BANG 6
from BusinessObject import Shippers as ShippersEntity         #BANG 7
from BusinessObject import Suppliers as SuppliersEntity       #BANG 8
...
class Employees:
    ...
    def update(self, employees: EmployeesEntity):
        ...
        cursor.execute(sql, (employees.lastname, employees.firstname, employees.birthdate, employees.photo, employees.notes, employees.employee_id))
        conn.commit()
        n = cursor.rowcount
        if n > 0:
            return 'Updated successfully', 200
...
class OrderDetails:
    ...
    def delete(self, orderdetails: OrderDetailsEntity):
        ...
        cursor.execute(sql, (orderdetails.orderdetail_id, ))
        conn.commit()
        n = cursor.rowcount
        if n > 0:
            return 'Deleted successfully', 200
    ...
    def update(self, orderdetails: OrderDetailsEntity):
        ...
        cursor.execute(sql, (orderdetails.order_id, orderdetails.product_id,orderdetails.quantity,orderdetails.orderdetail_id))
        conn.commit()
        n = cursor.rowcount
        if n > 0:
            return 'Updated successfully', 200
