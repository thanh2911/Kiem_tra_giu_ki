...
class Employees:
    ...
    def __init__(self, employee_id=None, lastname=None, firstname=None, birthdate=None, photo=None, notes=None):
...
class OrderDetails:
    ...
    def __init__(self, orderdetail_id=None, order_id=None, product_id=None, quantity=None):
    ...
    def to_json(self):
        return {
            'orderdetail_id': self.orderdetail_id,
